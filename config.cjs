...
const config = {
  SESSION_ID: process.env.SESSION_ID || "INCONNU~XD~wdIhGYjI#IvEKuDlYATZDncYuZwwYArrI2YX0Zd4VTdYrRCvD3Kc",
  PREFIX: process.env.PREFIX || 'a',
   BOT_NAME: process.env.BOT_NAME || "DRAGON 🐉",
  ...
  AUTO_REACT: process.env.AUTO_REACT !== undefined ? process.env.AUTO_REACT === 'fale' : false,
  ...
  SUDO_NUMBER: process.env.SUDO_NUMBER || "50935623320",
